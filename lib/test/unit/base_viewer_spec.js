...
describe("BaseViewer", function () {
  describe("PDFPageViewBuffer", function () {
    ...
    it("handles `push` correctly", function () {
      ...
      expect(buffer._buffer).toEqual([viewsMap.get(1), viewsMap.get(2), viewsMap.get(3)]);
      ...
      expect(buffer._buffer).toEqual([viewsMap.get(3), viewsMap.get(4), viewsMap.get(5)]);
    });
    it("handles `resize` correctly", function () {
      ...
      buffer.resize(5);
      expect(buffer._buffer).toEqual([viewsMap.get(1), viewsMap.get(2), viewsMap.get(3), viewsMap.get(4), viewsMap.get(5)]);
      buffer.resize(10);
      expect(buffer._buffer).toEqual([viewsMap.get(1), viewsMap.get(2), viewsMap.get(3), viewsMap.get(4), viewsMap.get(5)]);
      buffer.resize(3);
      expect(buffer._buffer).toEqual([viewsMap.get(3), viewsMap.get(4), viewsMap.get(5)]);
    ...
    it("handles `resize` correctly, with `idsToKeep` provided", function () {
      ...
      expect(buffer._buffer).toEqual([viewsMap.get(3), viewsMap.get(4), viewsMap.get(5), viewsMap.get(1), viewsMap.get(2)]);
      buffer.resize(10, new Set([3, 4, 5]));
      expect(buffer._buffer).toEqual([viewsMap.get(1), viewsMap.get(2), viewsMap.get(3), viewsMap.get(4), viewsMap.get(5)]);
      buffer.resize(3, new Set([1, 2, 5]));
      expect(buffer._buffer).toEqual([viewsMap.get(1), viewsMap.get(2), viewsMap.get(5)]);
    });
